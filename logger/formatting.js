...
/**
 * @typedef {[[number., number, number], [number, number, number]]} Gradient
 * */

/**
 * @typedef { Object } GradientCollection
 * @property {Gradient} purple
 * @property {Gradient} sunset
 * @property {Gradient} gray
 * @property {Gradient} orange
 * @property {Gradient} lime
